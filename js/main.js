/* =========================================================
   SCORE STORE — main.js (Vercel-aligned) — v2026-03-23
   Objetivo:
   - Nada roto: modales, carrito, checkout, cotización real
   - Assets blindados para Vercel (rutas absolutas /assets/)
   - Endpoints migrados a /api/ (Vercel Serverless Functions)
========================================================= */
(() => {
  "use strict";

  const APP_VERSION = window.__APP_VERSION__ || "2026.03.23.SCORESTORE-VERCEL";
  ...
  // ✅ Normaliza diferencias REALES de carpetas y asegura rutas para Vercel
  const safeUrl = (u) => {
    ...
    // Vercel requiere / inicial para assets estáticos
    return `/${s1}`;
  };
  ...
  // =========================================================
  // DOM refs (ID’s reales del index)
  // =========================================================
  const splash = $("#splash");
  ...
  // =========================================================
  // Fetchers (Migrados a Vercel /api/)
  // =========================================================
  ...
  // =========================================================
  // Render: Products + Product-card carousel
  // =========================================================
  ...
  // =========================================================
  // Shipping quote (Vercel): /api/quote_shipping
  // =========================================================
  ...
  // =========================================================
  // Checkout (Vercel): /api/create_checkout
  // =========================================================
